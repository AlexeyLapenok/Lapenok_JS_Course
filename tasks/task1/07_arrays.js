...
// let arraysArray = [[1, 2, 3, 4], [2, 3], [34, 23, 56]];
// function sortCopy(arraysArray) {
//     arraysArray.sort((a, b) => a.age > b.age ? 1 : -1);
//     return arraysArray.slice(0);
// }
// let sortedArraysArray = arraysArray.sort();
...
// к большему. const services = [ {service: "service1", executionTime: 56}, 
